...
/**
 * @extends ServiceEntityRepository<CategoriesTranslations>
 *
...
class CategoriesTranslationsRepository extends ServiceEntityRepository
{
    ...
    public function add(CategoriesTranslations $entity, bool $flush = false): void
    {
    ...
    public function remove(CategoriesTranslations $entity, bool $flush = false): void
    {
